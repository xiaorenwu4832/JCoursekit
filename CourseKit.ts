...
liquid block
*/
//% weight=80 color=#66FFFF icon="\uf043" block="液位检测"
namespace Liquid {
...
sound block
*/
//% weight=70 color=#CC6633 icon="\uf001" block="麦克风"
namespace Sound {
...
infrared  block
*/
//% weight=60 color=#FF0000 icon="\uf0eb" block="红外避障"
namespace Infrared {
    let Apin = AnalogPin.P0;
    let Dpin = DigitalPin.P1;
...
flame block
*/
//% weight=40 color=#FF6633 icon="\uf06d" block="火焰检测"
namespace Flame {
    let Apin = AnalogPin.P0;
    let Dpin = DigitalPin.P1;
...
moisture block
*/
//% weight=30 color=#FF9900 icon="\uf275" block="土壤湿度"
namespace Moisture {
    let pin = AnalogPin.P0
    let volt = 0;
    let adc = 0;
